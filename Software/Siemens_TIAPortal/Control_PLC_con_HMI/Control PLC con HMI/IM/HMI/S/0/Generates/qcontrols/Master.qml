...
Item{
    ...
    property bool configuredfromRT: virtualkeyboard.isconfiguredfromRT()
   ...
   // signal vkescapeClicked()
    ...
    function start()
    {
        ...
        if(screenSize ==="7" || screenSize ==="9" )
        {
            ...
            qm_buttonWidth = landscapeMode?style.sevenToNineInch_LandscapeMode_buttonWidth_ForAlphaNumericKeypad:style.sevenToNineInch_PotraitMode_buttonWidth_ForAlphaNumericKeypad
            qm_buttonHeight = landscapeMode?style.sevenToNineInch_LandscapeMode_buttonHeight_ForAlphaNumericKeypad:style.sevenToNineInch_PotraitMode_buttonHeight_ForAlphaNumericKeypad
            ...
            qm_buttonWidthForNumericKeypad = landscapeMode?style.sevenToNineInch_LandscapeMode_buttonWidthForNumericKeypad:style.sevenToNineInch_PortraitMode_buttonWidthForNumericKeypad
            qm_buttonHeightForNumericKeypad = landscapeMode?style.sevenToNineInch_LandscapeMode_buttonHeightForNumericKeypad:style.sevenToNineInch_PortraitMode_buttonHeightForNumericKeypad
            ...
            qm_DiffRotateX = (landscapeMode ? 0 : -150)
            qm_DiffRotateY = (landscapeMode ? 0 : 150)
        }
        if(screenSize ==="12")
        {
            ...
            qm_DiffRotateX = (landscapeMode ? 0 : 110)
            qm_DiffRotateY = (landscapeMode ? 0 : -110)
        }
        ...
        dynamicComponentObj = dynamicComponent.createObject(qSoftKeypad,
                                                          {
                                                              ...
                                                              "qm_configuredfromRT": configuredfromRT,
                                                              "qm_DiffRotateX": qm_DiffRotateX,
                                                              "qm_DiffRotateY": qm_DiffRotateY
                                                          })
        ...
        dynamicComponentObj.onpositionChanged.connect(onPositionChanged)
        }
    ...
    {
        virtualkeyboard.slot_positionChanged(x, y)
    }
